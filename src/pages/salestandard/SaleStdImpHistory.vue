...
onMounted(() => {
    ...
    storeApp.setPageTitle("ประวัติการแก้ไขราคามาตรฐาน");
...
function getDetailList() {
    ...
    MasterdataService.getDocStdHistory(search.value, from_datex, to_datex, sale_type, trans_type, price_type, groupmain, groupsub, itembrand, itemmodel, itempattern, itemcategory, itemdesign)
        .then((res) => {
            console.log(res);
